...
def create_display_layout(sensor_data, historical_data, system_status):
    ...
    temp_elements = create_temperature_elements(temp_str, is_negative, 20, 25)
    elements.extend(temp_elements)

    # Temperature averages
    temp_avg_text = f"D:{historical_data['temp_averages']['day']} W:{historical_data['temp_averages']['week']} M:{historical_data['temp_averages']['month']} Y:{historical_data['temp_averages']['year']}"
    elements.append({
        'type': 'text',
        'text': temp_avg_text,
        'font': 'tiny',
    ...
    elements.append({
        'type': 'rect',
        'x': 0, 'y': temp_y_start - 2,
        'width': DISPLAY_WIDTH, 'height': temp_height + 4,
    ...
    elements.append({
        'type': 'rect',
        'x': 0, 'y': humidity_y_start - 2,
        'width': DISPLAY_WIDTH, 'height': humidity_height + 4,
    ...
    humidity_avg_text = f"D:{historical_data['humidity_averages']['day']} W:{historical_data['humidity_averages']['week']} M:{historical_data['humidity_averages']['month']} Y:{historical_data['humidity_averages']['year']}"
    elements.append({
        'type': 'text',
